...
public class AppOnFile {
    private static final String FILENAME = "/Users/kimbergz/Downloads/amazon-kinesis-video-streams-producer-sdk-java/video.mkv";

    public static void main(String[] args)
        throws IOException, ModelNotFoundException, MalformedModelException, MkvElementVisitException {
